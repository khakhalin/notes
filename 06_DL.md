...
Subtopics:
* [[regularization]]
* gradient descent methods (aka **optimizers**)
    * [[Ruder2016descent]] - overview
    * [[adam]] - most popular
* Specific architectures:
    ...
    * [[09_Graphs]]
* Libraries: [[tensorfow]]
* [[ml_lore]] - list of practical advice
...
**Hyperparameters**: those somewhat arbitrary values that define the type of solution the model is looking for, and the process of descent. See also:
* [[hyperparameters]] - general info on how to tune them
* [[tensorflow]] - for some practical advice
