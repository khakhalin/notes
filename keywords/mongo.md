...
🔥 I'm still not sure if it is advisable to hash a key in a situation of quazy-tabular access (say, with 2 categories and a date), but leaning towards "no". It seems that dates are so good in being naturally sortable that you don't need a hashtable.
