...
There's a claim that dropout should not be used on convolutional networks, because it does not actually work (does not inactivate elements), as convolution introduces coordination between changes in different weights. Also, there's no risk of overfitting with convolutions, which means that regularization is not necessary in general. Refs [1](https://towardsdatascience.com/dropout-on-convolutional-layers-is-weird-5c6ab14f19b2), [2](https://www.kdnuggets.com/2018/09/dropout-convolutional-networks.html)
