...
A computationally solid approach to calculating θ, that works better than inverse matrices. The idea: break y into x and everything else, as if the basis was orthonormal, then update si iteratively.
